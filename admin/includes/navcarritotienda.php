...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="./tienda.php" method="POST">
                <button class="btn btn-outline-success me-2 mb-3 mb-lg-0" type="submit">Tienda</button>
            </form>
            ...
            <form class="d-flex" action="./productos.php" method="POST">
                <button class="btn btn-outline-light me-2 mb-3 mb-lg-0" type="submit">Stock</button>
            </form>

            <form class="d-flex" action="./agregar_producto.php" method="POST">
                <button class="btn btn-outline-warning mb-3 mb-lg-0" type="submit">Agregar</button>&nbsp&nbsp
            </form>

            <form class="d-flex" action="./productos.php" method="POST">
                <button class="btn btn-outline-warning mb-3 mb-lg-0" type="submit">Modificar</button>&nbsp&nbsp
            </form>
