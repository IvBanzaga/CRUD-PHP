    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="tienda.php" method="POST">
                <button class="btn btn-outline-success me-2 mb-3 mb-lg-0" type="submit">Volver a la Tienda</button>
            </form>
            ...
            <form class="d-flex" action="agregar_producto.php" method="POST">
                <button class="btn btn-outline-warning mb-3 mb-lg-0" type="submit">Registro de Productos</button>
            </form>
