...
function actualizarProducto($id_producto, $nombre, $precio, $descripcion, $imagen)
{
    // Conexión a la base de datos
    $conexion = obtenerConexion();

    // Preparar la consulta SQL
    $consulta = $conexion->prepare("UPDATE productos SET nombre = ?, precio = ?, descripcion = ?, nombre_archivo = ? WHERE id = ?");

    // Ejecutar la consulta
    $consulta->execute([$nombre, $precio, $descripcion, $imagen, $id_producto]);
